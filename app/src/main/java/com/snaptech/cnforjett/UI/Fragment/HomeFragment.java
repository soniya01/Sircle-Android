package com.snaptech.cnforjett.UI.Fragment;
...
import com.snaptech.cnforjett.DownLoader.FetchAppData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        newsletter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fragmentToLoad != null) {
                    loadFragment(getActivity(), fragmentToLoad,"Information",4);
        ...
        documents.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fragmentToLoad != null) {
                    loadFragment(getActivity(), fragmentToLoad,"Circulars",5);
...
//                }
                ...
                if (fragmentToLoad != null) {
                    ...
                    if (!userType.equals("admin")) {
                        loadFragment(getActivity(), fragmentToLoad,"Contact us",9);
                    }
                    else
                    {
                        loadFragment(getActivity(), fragmentToLoad,"Contact us",8);
                    }
