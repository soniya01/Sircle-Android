package com.snaptech.americanmontesorri.UI.Fragment;
...
import com.snaptech.americanmontesorri.UI.Activity.VimeoWebviewActivity;
import com.snaptech.americanmontesorri.UI.Adapter.VideoListViewAdapter;
import com.snaptech.americanmontesorri.UI.Model.Video;
import com.snaptech.americanmontesorri.Utility.AppError;
import com.snaptech.americanmontesorri.Utility.Constants;
import com.snaptech.americanmontesorri.Utility.DeveloperKey;
            ...
            VideoManager.getSharedInstance().getAllVideos(object, new VideoManager.VideoManagerListener() {
                ...
                public void onCompletion(VideoResponse response, AppError error) {
                    ...
                    if (Constants.flag_logout) {
                       ...
                       // Toast.makeText(getActivity(), "Please reopen the app to Login again.", Toast.LENGTH_LONG).show();
