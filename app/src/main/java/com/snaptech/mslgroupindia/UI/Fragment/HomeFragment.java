...
import com.snaptech.mslgroupindia.DownLoader.FetchAppData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        newsletter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fragmentToLoad != null) {
                    loadFragment(getActivity(), fragmentToLoad,"Weekly Insights",4);
...
//                }
                ...
                if (fragmentToLoad != null) {
                    ...
                    if (!userType.equals("admin")) {
                        loadFragment(getActivity(), fragmentToLoad,"Corporate Address",9);
                    }
                    else
                    {
                        loadFragment(getActivity(), fragmentToLoad,"Corporate Address",8);
                    }
