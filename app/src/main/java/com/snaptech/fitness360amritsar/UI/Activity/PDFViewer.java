...
import com.snaptech.fitness360amritsar.DownLoader.FileDownloader;
...
//            {
            ...
            if(pdfFile.exists() && pdfFile.length() != 0) {
                ...
                pdfView.fromFile(pdfFile).defaultPage(1).onPageChange((OnPageChangeListener) PDFViewer.this).load();
                pdfPageCount.setText(pdfView.getCurrentPage() + "/" + pdfView.getPageCount());
            }
