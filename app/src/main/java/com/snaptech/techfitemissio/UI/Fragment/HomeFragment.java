...
import com.snaptech.techfitemissio.DownLoader.FetchAppData;
...
//                }
                ...
                if (fragmentToLoad != null) {
                    ...
                    if (!userType.equals("admin")) {
                        loadFragment(getActivity(), fragmentToLoad,"Gym Information",9);
                    }
                    else
                    {
                        loadFragment(getActivity(), fragmentToLoad,"Gym Information",8);
                    }
