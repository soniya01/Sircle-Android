...
import com.snaptech.kapruddin2016.DownLoader.FetchAppData;
...
//                }
                ...
                if (fragmentToLoad != null) {
                    ...
                    if (!userType.equals("admin")) {
                        loadFragment(getActivity(), fragmentToLoad,"Wedding Information",9);
                    }
                    else
                    {
                        loadFragment(getActivity(), fragmentToLoad,"Wedding Information",8);
                    }
