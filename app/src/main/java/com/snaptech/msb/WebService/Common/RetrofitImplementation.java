               ...
               // postWebservice.login(params.get("email"), params.get("password"), params.get("device_token"), params.get("device_type"), new Callback<JsonElement>() {
                postWebservice.login(params.get("email"), params.get("password"), params.get("device_token"), params.get("device_type"), new Callback<JsonElement>() {
                    ...
                    public void success(JsonElement jsonElement, Response response) {
                        ...
                        System.out.println("Response for login is "+jsonElement.toString());
                        if (!jsonElement.isJsonNull() ){
...
//                                    }
                    ...
                    public void failure(RetrofitError error) {
                        ...
                        System.out.println("Inside error "+error.getCause()+" or "+error.getLocalizedMessage()+" code is "+getRetrofitErrorcode(error));
