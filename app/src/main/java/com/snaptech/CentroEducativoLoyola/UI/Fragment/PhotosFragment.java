package com.snaptech.CentroEducativoLoyola.UI.Fragment;
...
import com.snaptech.CentroEducativoLoyola.UI.Activity.AddAlbumActivity;
import com.snaptech.CentroEducativoLoyola.UI.Activity.AlbumDetailsActivity;
import com.snaptech.CentroEducativoLoyola.UI.Adapter.PhotosListViewAdapter;
import com.snaptech.CentroEducativoLoyola.UI.Model.Photo;
        ...
        switch (requestCode) {
            case 1: {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getActivity(),"Por favor den permiso de cámara",Toast.LENGTH_SHORT).show();
