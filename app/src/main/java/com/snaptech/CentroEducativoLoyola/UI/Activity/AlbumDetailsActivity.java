...
import com.snaptech.CentroEducativoLoyola.Manager.PhotoManager;
import com.snaptech.CentroEducativoLoyola.R;
import com.snaptech.CentroEducativoLoyola.UI.Adapter.AlbumDetailsGridAdapter;
import com.snaptech.CentroEducativoLoyola.UI.Fragment.PhotosFragment;
import com.snaptech.CentroEducativoLoyola.UI.Model.AlbumDetails;
import com.snaptech.CentroEducativoLoyola.UI.cam.activity.CameraActivity;
...
import com.snaptech.CentroEducativoLoyola.WebService.AlbumResponse;
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (getIntent().getExtras() != null)
        {
            ...
            if(InternetCheck.isNetworkConnected(AlbumDetailsActivity.this))
                ...
                Toast.makeText(AlbumDetailsActivity.this,"Compruebe internet",Toast.LENGTH_SHORT).show();//            shouldSelectListViewItem = true;
        ...
        switch (requestCode) {
            ...
            case 1: {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(AlbumDetailsActivity.this,"Por favor den permiso de cámara.",Toast.LENGTH_SHORT).show();
