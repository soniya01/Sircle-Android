...
import com.grayjam.sircle.DownLoader.FetchAppData;
...
public class HomeFragment extends Fragment {
  ...
  //  private ProgressBar progressBar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        notifications.setText(getResources().getStringArray(R.array.array_module_name)[3]);
        ...
        notifications.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fragmentToLoad != null) {
                    loadFragment(getActivity(), fragmentToLoad,getResources().getStringArray(R.array.array_module_name)[3],3);
